...
const UnamPushUpCanvas = styled.div`
  z-index: 1;
  height: 18vh;
  width: 22vh;
  max-height: 100%;
...
export default function UnamPushUpScene() {
  ...
  useEffect(() => {
    ...
    gltfLoader.load("/assets/unam3d/unampushup.glb", (gltf) => {
      model.current = gltf.scene;
      model.current.position.y = -0.115;
      ...
      model.current.scale.set(0.2, 0.2, 0.2);
